...
namespace OpenH264Test
{
    ...
    {
        static readonly byte[] BoxFTYP =
        {
            0x00, 0x00, 0x00, 0x18, 0x66, 0x74, 0x79, 0x70, 0x6d, 0x70, 0x34, 0x32, 0x00, 0x00, 0x00, 0x00, 0x6d, 0x70,
                    ...
                    switch (payload_type)
                    {
                        ...
                        case 5:
                            ...
                            if (h.need_pps == 0 && h.need_idr == 0)
                            {
                                ...
                                MP4E__put_sample(h.mux, h.mux_track_id, nal2, sizeof_nal, timeStamp90kHz_next,
                                    sample_kind);
                            }
                    ...
                    for (var layerIdx = 0; layerIdx < info.LayerNum; layerIdx++)
                    {
                        ...
                        unsafe
                        {
                            ...
                            for (var iNalIdx = 0; iNalIdx < pLayerBsInfo->NalCount; iNalIdx++)
                            {
                                ...
                                var nal = FindNalUnit((byte*) pLayerBsInfo->pBsBuf + layerSize, nalSize,
                                    out nal_unit_bytes);
